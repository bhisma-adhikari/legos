...
- j1, j2 and j3 are jackson library jar files renamed to make the compilation commands shorter. 
    j1: jackson-annotations-2.8.4.jar
    j2: jackson-core-2.8.4.jar 
    j3: jackson-databind-2.8.4.jar 
...
- Make sure that the following 3 jars file are in the current directory:
    - jackson-annotations-2.8.4.jar (as j1)
    - jackson-core-2.8.4.jar        (as j2)
    - jackson-databind-2.8.4.jar    (as j3)
